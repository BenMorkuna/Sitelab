    ...
    packages: [
      {
        ...
        outcomes: ['Rank for your core keywords', 'Fix technical issues hurting your visibility', 'Optimized pages that convert visitors', 'Monthly report showing real progress'],
      ...
      },
      {
        ...
        outcomes: ['Everything in Starter', 'GEO: get recommended by ChatGPT & AI tools', 'CRO: turn more visitors into paying customers', 'Content strategy that builds authority', 'Competitor gap analysis & targeting'],
        gradient: 'from-[#43ffae] to-[#13aff0]', cta: 'Get the Growth Plan',
      },
      {
        name: 'Scale', price: 'From €1,099/mo', tag: null,
        ...
        outcomes: ['Everything in Growth', 'E-commerce SEO (products, categories, schema)', 'Advanced CRO — cart & checkout optimization', 'Full AI search visibility across all platforms', 'Priority execution & dedicated reporting'],
    ...
    packages: [
      {
        ...
        outcomes: ['Renkitės pagrindiniais raktažodžiais', 'Ištaisykite techninius trūkumus', 'Optimizuoti puslapiai, kurie konvertuoja', 'Mėnesinė ataskaita su realiais rezultatais'],
      ...
      },
      {
        ...
        outcomes: ['Viskas iš Pradinio', 'GEO: būkite rekomenduojami ChatGPT ir AI įrankiuose', 'CRO: paverčiame daugiau lankytojų mokančiais klientais', 'Turinio strategija, kuri kuria autoritetą', 'Konkurentų analizė ir taikymas'],
        gradient: 'from-[#43ffae] to-[#13aff0]', cta: 'Gauti Augimo Planą',
      },
      {
        name: 'Mastas', price: 'Nuo €1.099/mėn.', tag: null,
        ...
        outcomes: ['Viskas iš Augimo', 'E-komercijos SEO (produktai, kategorijos, schema)', 'Pažengęs CRO — krepšelio ir atsiskaitymo optimizavimas', 'Pilnas AI paieškos matomumas visose platformose', 'Prioritetinis vykdymas ir skirta ataskaita'],
