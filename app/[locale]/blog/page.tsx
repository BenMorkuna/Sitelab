                  ...
                  <article className="bg-[#1b1b1b] rounded-xl border border-gray-800 overflow-hidden hover:border-[#13aff0]/30 transition-all group cursor-pointer">
                    <div className="grid md:grid-cols-5 gap-6 p-6">
                      ...
                      <div className="md:col-span-2">
                        <div className="aspect-video rounded-lg overflow-hidden group-hover:scale-105 transition-transform">
                          {post.image ? (
                            <img
                              src={post.image}
                              alt={post.title}
                            ...
                            <div className="w-full h-full bg-gradient-to-br from-[#13aff0]/20 to-[#43ffae]/20 flex items-center justify-center">
